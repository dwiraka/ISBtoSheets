...
const parametersRange = 'E-Purchasing!N2:N'; 
const clearRange = 'E-Purchasing!AL:CN'; 
const updateRange = 'E-Purchasing!AL1'; 
...
async function fetchData() {
    try {
        ...
        const apiUrl = process.env.API_URL_EP_PROD; // Use the environment variable
        ...
        const successMessage = '✅ Data Produk Detail successfully written to Google Sheets';
