...
const url = process.env.API_URL_TD; // Use environment variable for URL

// Define the spreadsheet ID and range
const spreadsheetId = process.env.SPREADSHEET_ID; // Use environment variable for Spreadsheet ID
const clearRange = 'TokoDaring!A:ZZ'; // Range to clear
const updateRange = 'TokoDaring!A1'; // Range to update
...
async function fetchData() {
    try {
        ...
        const successMessage = `✅ Data TokoDaring successfully written to Google Sheets. Updated rows: ${rows.length}`;
