...
const parametersRange = 'E-Purchasing!Y2:Y'; 
const clearRange = 'E-Purchasing!DX:ZZ'; 
const updateRange = 'E-Purchasing!DX1'; 
...
async function fetchData() {
    try {
        ...
        const apiUrl = process.env.API_URL_EP_USERPPK; // Use the environment variable
        ...
        const successMessage = '✅ Data UserPPk successfully written to Google Sheets';
